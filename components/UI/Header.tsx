  ...
  return (
    ...
    >
      ...
      <MenuList
        ...
        } z-50 gap-6 text-md flex flex-col justify-end align-top text-right mr-2 absolute right-0 bg-gray-100/50 dark:bg-gray-900 p-6  border-r-2 border-gray-50/50 w-full`}
      />
    </header>
  );
};
...
const BurgerButton = ({ onClickHandle }: BurgerButtonProps) => (
  <button
